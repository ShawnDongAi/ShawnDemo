package com.shawn.lib.smooth_progress;
	...
	public static class Builder {
		...
		private void initValues(Context context, boolean editMode) {
			...
			if (!editMode) {
				...
				mSpeed = Float.parseFloat(res
						.getString(R.string.spb_default_speed));
		...
		public Builder sectionsCount(int sectionsCount) {
			SmoothProgressBarUtils.checkPositive(sectionsCount,
					"Sections count");
			mSectionsCount = sectionsCount;
			return this;
		}
		...
		public Builder separatorLength(int separatorLength) {
			SmoothProgressBarUtils.checkPositiveOrZero(separatorLength,
					"Separator length");
