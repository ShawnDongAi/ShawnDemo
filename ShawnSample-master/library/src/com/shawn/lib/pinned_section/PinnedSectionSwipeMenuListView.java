...
import com.shawn.lib.swipe_menu.SwipeMenuAdapter;
import com.shawn.lib.swipe_menu.SwipeMenuListView;
 ...
 */
public class PinnedSectionSwipeMenuListView extends SwipeMenuListView {
    ...
    public PinnedSectionSwipeMenuListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PinnedSectionSwipeMenuListView(Context context, AttributeSet attrs, int defStyle) {
	...
	void createPinnedShadow(int position) {
		...
		View pinnedView = getAdapter().getView(position, pinnedShadow.view, PinnedSectionSwipeMenuListView.this);
