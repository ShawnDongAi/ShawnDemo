...
public abstract class MenuDrawer extends ViewGroup {
    ...
    public static MenuDrawer attach(Activity activity) {
        return attach(activity, MenuDrawer.MENU_DRAG_CONTENT);
    }
    ...
    public static MenuDrawer attach(Activity activity, int dragMode) {
        MenuDrawer menuDrawer = createMenuDrawer(activity, dragMode);
    ...
    private static MenuDrawer createMenuDrawer(Activity activity, int dragMode) {
        MenuDrawer drawer = new OverlayDrawer(activity, dragMode);
    ...
    protected void initDrawer(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mDropShadowDrawable == null) {
            mDropShadowColor = a.getColor(R.styleable.MenuDrawer_mdDropShadowColor, 0x00000000);
        } else {
    ...
    private void drawIndicator(Canvas canvas) {
        ...
        if (pos == mActivePosition) {
            ...
            int drawLeft = mIndicatorClipRect.left;
            int drawTop = mIndicatorClipRect.top;
    ...
    public void setDropShadowColor(int color) {
        ...
        mDropShadowDrawable = new GradientDrawable(GradientDrawable.Orientation.RIGHT_LEFT,
                new int[] {
                        color,
                        endColor,
                });
